    ...
    return (
        <section className="mt-12 h-fit">
            ...
            <div className="p-4 mb-10 flex gap-5">
                <select className="bg-white p-3 pr-5 pl-5 focus:outline-0 border font-light cursor-pointer *:font-light">
                ...
                <a className="p-3 pr-5 pl-5 bg-purple-900 text-white font-light hover:bg-purple-950 cursor-pointer transition-all duration-500" href="">Explore Collections</a>
            </div>
            <div className="flex gap-10 flex-wrap p-5 justify-center">
                ...
                <div className="w-65 h-80 bg-white relative group overflow-hidden">
                    ...
                    <a href={`/overview?productId=`} className="bg-gray-900/10 font-semibold backdrop-blur-2xl cursor-pointer opacity-0 text-white p-3 text-sm left-1/2 top-1/2 absolute -translate-x-1/2 -translate-y-1/2 pl-5 pr-5 group-hover:opacity-100 transition-all duration-700">VIEW</a>
                </div>
            </div>
